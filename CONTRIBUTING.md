...
ViewLogic's query-based routing is **fully SEO-friendly** when combined with prerendering. This approach is proven by major platforms like YouTube and Amazon.

### Prerendering Solutions

For public-facing websites that require SEO:

**Cloud Services**:
- **Prerender.io** - Managed prerendering service
- **Rendertron** - Google's open-source solution

**Self-Hosted**:
- **Puppeteer** - Headless Chrome for custom prerendering

### Implementation (Nginx + Prerender.io)
...
**1. Meaningful Route Names**
```javascript
// ✅ GOOD: Descriptive routes
...
export default {
    ...
    mounted() {
        ...
        document.querySelector('meta[name="description"]')
            .setAttribute('content', this.post.excerpt);
    }
};
```
...
**Needed**:
- ✅ Public-facing websites (blogs, e-commerce, marketing)
- ✅ Social media sharing requirements
- ✅ Search engine indexing

**Not Needed**:
- ❌ Admin panels (behind authentication)
- ❌ Internal tools
- ❌ Private dashboards

**Note**: Prerendering only affects bots. Regular users get full SPA performance with instant navigation.
